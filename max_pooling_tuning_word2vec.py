...
model = RNN_Simple(embedding_matrix_1=embedding_matrix, embedding_dimension=embedding_dim, vocab_size=vocab_size, hidden_size=hidden_size, output_size=output_dim, num_layers=number_of_layers)
...
depth_options = [1, 2, 3]  # Number of RNN layers
width_options = [64, 128, 256]  # Hidden layer sizes
...
for num_layers in depth_options:
    for hidden_size in width_options:
