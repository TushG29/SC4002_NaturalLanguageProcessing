...
train_data_processed = [(preprocessing_data(review_data['text'], vocab_rnn, max_length), review_data['label']) for review_data in train_data]
valid_data_processed = [(preprocessing_data(review_data['text'], vocab_rnn, max_length), review_data['label']) for review_data in val_data]
test_data_processed = [(preprocessing_data(review_data['text'], vocab_rnn, max_length), review_data['label']) for review_data in test_data]
